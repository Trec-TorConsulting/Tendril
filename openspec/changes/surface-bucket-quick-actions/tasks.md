...
- [ ] 4.2 Add "Water Change" option to Quick Log (not just "Feeding" and "Reading")
- [ ] 4.3 Quick Log Water Change: bucket selector + pH + EC + notes → creates journal entry + reading

## 5. Overview Tab Enhancement
- [ ] 5.1 Add "Bucket Status" summary card to Overview tab showing each bucket's last water change date
- [ ] 5.2 Highlight any buckets overdue for water change in the summary

## 6. Testing
- [ ] 6.1 Unit test: `last_water_change_at` computation from journal entries
- [ ] 6.2 Unit test: quick journal endpoint creates both entry and reading
- [ ] 6.3 E2E test: water change flow from bucket card
