...
export const STANDALONE_ADDITIVES: StandaloneAdditive[] = [
  ...
  {
    id: "botanicare-calmag-plus",
    name: "Cal-Mag Plus",
    brand: "Botanicare",
    description: "Calcium, magnesium, and iron supplement. Prevents deficiencies common in RO water, coco, and LED grows.",
    ml_per_gallon: 5,
    when: "Every feeding. Add first to reservoir before base nutrients. Reduce to 2.5 ml/gal in late flower.",
    growTypes: ["dwc", "rdwc", "coco", "nft", "ebb_flow", "aeroponics", "kratky", "soil"],
  },
  {
    id: "gh-armor-si",
    name: "Armor Si",
    brand: "General Hydroponics",
    description: "Potassium silicate strengthens cell walls, improves heat/drought tolerance, and increases pest resistance.",
    ml_per_gallon: 1.5,
    when: "Every feeding. Add first to fresh water before other nutrients. Stop in the last 2 weeks before harvest.",
    growTypes: ["dwc", "rdwc", "coco", "nft", "ebb_flow", "aeroponics", "kratky", "soil"],
  },
  {
    id: "gh-rapidstart",
    name: "RapidStart",
    brand: "General Hydroponics",
    description: "Root enhancer with plant-derived compounds for vigorous root development in early growth stages.",
    ml_per_gallon: 1,
    when: "Seedling through early veg (first 3–4 weeks). Discontinue once root mass is established.",
    growTypes: ["dwc", "rdwc", "coco", "nft", "ebb_flow", "aeroponics", "kratky", "soil"],
  },
  {
    id: "slf100",
    name: "SLF-100",
    brand: "SLF-100",
    description: "Enzymatic formula that breaks down dead root matter and salt buildup, keeping roots and res clean.",
    ml_per_gallon: 1,
    when: "Every reservoir change. Can be used throughout entire grow cycle including flush.",
    growTypes: ["dwc", "rdwc", "coco", "nft", "ebb_flow", "aeroponics", "kratky"],
  },
  {
    id: "mammoth-p",
    name: "Mammoth P",
    brand: "Mammoth Microbes",
    description: "Phosphorus-liberating microbial inoculant that increases available phosphorus by up to 16%.",
    ml_per_gallon: 0.16,
    when: "From mid-veg through end of flower. Add at every reservoir change.",
    growTypes: ["dwc", "rdwc", "coco", "nft", "ebb_flow", "aeroponics", "kratky", "soil"],
  },
  {
    id: "recharge",
    name: "Recharge",
    brand: "Real Growers",
    description: "Beneficial microbe blend with mycorrhizae, trichoderma, and kelp for soil and soilless media.",
    ml_per_gallon: 0.5,
    when: "Once per week as a drench. Best for soil and coco — can cloud DWC reservoirs.",
    growTypes: ["coco", "soil"],
  },
];
