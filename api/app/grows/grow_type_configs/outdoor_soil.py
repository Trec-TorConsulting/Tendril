...
OUTDOOR_SOIL_STAGES: list[dict] = [
    ...
    # ── 13. STORAGE ──────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {
                ...
                "description": "Home: mason jars with Boveda 58-62%. Commercial: nitrogen-sealed grove bags, CVault, or nitrogen-flushed drums. OUTDOOR YIELDS ARE HUGE — plan container volume for pounds, not ounces.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Extra mold inspection for outdoor flower",
                "description": "Outdoor flower had more environmental mold spore exposure than indoor. Inspect more frequently in first month of storage. Any suspicious buds: remove immediately.",
                "interval_days": 7,
                "priority": "high",
            },
            {
                "name": "Label and track batches",
                "description": "Strain, harvest date, storage date, weight, batch number, grow method (organic/synthetic). Commercial: seed-to-sale, FIFO.",
                "interval_days": None,
                "priority": "high",
            },
            {
            ...
            },
            {
                ...
                "description": "First in, first out. Outdoor harvests are annual — entire year's production stored at once.",
                "interval_days": 30,
                "priority": "medium",
            },
            {
                "name": "Compliance testing holds",
                "description": "Commercial: retain samples per regulations. Outdoor flower may need additional microbial testing.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        "health_checks": [
            ...
            "FIFO maintained?",
            "Extra mold checks for outdoor flower?",
        ],
        "common_problems": [
            {
                "issue": "Mold from outdoor spore exposure",
                "cause": "Outdoor flower carries more environmental mold spores than indoor",
                "solution": "Extra inspection first 30 days. Remove any suspicious buds. Nitrogen-sealed containers reduce mold risk. If in doubt: test.",
            },
            {
            ...
            {
                "issue": "Storage volume overwhelm",
                "cause": "Outdoor yields are 5-20x larger than indoor per plant",
                "solution": "Plan storage BEFORE harvest. Grove bags and turkey bags for large volumes. Dedicated vault room for commercial.",
            },
            {
                "issue": "Weight loss",
        ...
        "environment_variants": {
            "outdoor": {
                "environment_overrides": {
                    "notes": "Storage is always indoor. Extra mold vigilance for field-grown flower."
                },
                "extra_tasks": [],
                "extra_problems": [],
