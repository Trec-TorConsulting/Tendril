...
OUTDOOR_SOIL_STAGES: list[dict] = [
    ...
    # ── 13. STORAGE ──────────────────────────────────────────────────────
    {
        ...
        "description": "Post-cure long-term storage. Outdoor soil grows produce MASSIVE yields — a single plant can produce 1-5+ lbs. Storage planning is critical. Outdoor flower has higher mold spore exposure from its growing environment, so extra vigilance during storage is essential. Organic outdoor soil flower is prized by connoisseurs for exceptional terpene complexity — protect that investment.",
        "environment": {
            ...
            "notes": "DARK. Cool. Stable. Zero light — UV destroys cannabinoids and terpenes. Commercial: 58-62°F, 55-60% RH, nitrogen atmosphere. Outdoor flower needs extra mold vigilance due to field exposure.",
        },
        "medium": None,
        ...
        "tasks": [
            {"name": "Transfer to long-term containers", "description": "Home: mason jars with Boveda 58-62%. Commercial: nitrogen-sealed grove bags, CVault, or nitrogen-flushed drums. OUTDOOR YIELDS ARE HUGE — plan container volume for pounds, not ounces.", "interval_days": None, "priority": "high"},
            {"name": "Extra mold inspection for outdoor flower", "description": "Outdoor flower had more environmental mold spore exposure than indoor. Inspect more frequently in first month of storage. Any suspicious buds: remove immediately.", "interval_days": 7, "priority": "high"},
            {"name": "Label and track batches", "description": "Strain, harvest date, storage date, weight, batch number, grow method (organic/synthetic). Commercial: seed-to-sale, FIFO.", "interval_days": None, "priority": "high"},
            ...
            {"name": "Rotate stock (FIFO)", "description": "First in, first out. Outdoor harvests are annual — entire year's production stored at once.", "interval_days": 30, "priority": "medium"},
            {"name": "Compliance testing holds", "description": "Commercial: retain samples per regulations. Outdoor flower may need additional microbial testing.", "interval_days": None, "priority": "medium"},
        ],
        "health_checks": ["Temp 55-65°F?", "Humidity 55-62%?", "Complete darkness?", "No mold/off odors?", "Humidity packs active?", "FIFO maintained?", "Extra mold checks for outdoor flower?"],
        "common_problems": [
            {"issue": "Mold from outdoor spore exposure", "cause": "Outdoor flower carries more environmental mold spores than indoor", "solution": "Extra inspection first 30 days. Remove any suspicious buds. Nitrogen-sealed containers reduce mold risk. If in doubt: test."},
            ...
            {"issue": "Storage volume overwhelm", "cause": "Outdoor yields are 5-20x larger than indoor per plant", "solution": "Plan storage BEFORE harvest. Grove bags and turkey bags for large volumes. Dedicated vault room for commercial."},
        ...
        "environment_variants": {
            "outdoor": {"environment_overrides": {"notes": "Storage is always indoor. Extra mold vigilance for field-grown flower."}, "extra_tasks": [], "extra_problems": [], "notes": "Indoor controlled environment."},
        ...
        "commercial_scale": {
            "container_progression": {
                "home_small": "Mason jars with Boveda packs (you'll need LOTS for outdoor yields)",
                "home_large": "Grove bags or turkey bags (more practical for outdoor volumes)",
            ...
            "degradation_timeline": {
                "0_3_months": "Peak quality. Outdoor organic terps continuing to develop.",
                "3_6_months": "Slight terpene reduction (~10-15%). Still premium outdoor.",
                "6_12_months": "Noticeable terpene loss (~20-30%). THC down ~5%.",
                "12_18_months": "Significant decline. Process into extracts or edibles.",
