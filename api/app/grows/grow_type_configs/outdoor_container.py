...
OUTDOOR_CONTAINER_STAGES: list[dict] = [
    ...
    # ── 13. STORAGE ──────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {"name": "Transfer to long-term containers", "description": "Home: mason jars with Boveda 58-62%. Commercial: nitrogen-sealed grove bags, CVault, or nitrogen-flushed drums. Container yields are more manageable than in-ground.", "interval_days": None, "priority": "high"},
            {"name": "Extra mold inspection for outdoor flower", "description": "Outdoor flower had environmental mold spore exposure. Inspect more frequently first month.", "interval_days": 7, "priority": "high"},
            {"name": "Label and track batches", "description": "Strain, harvest date, storage date, weight, batch number, container size/medium. Commercial: seed-to-sale, FIFO.", "interval_days": None, "priority": "high"},
        ...
        "common_problems": [
            {"issue": "Mold from outdoor spore exposure", "cause": "Outdoor flower carries more environmental mold spores", "solution": "Extra inspection first 30 days. Nitrogen-sealed containers reduce risk."},
        ...
        "environment_variants": {
            "outdoor": {"environment_overrides": {"notes": "Storage is always indoor. Extra mold checks for outdoor flower."}, "extra_tasks": [], "extra_problems": [], "notes": "Indoor controlled environment."},
