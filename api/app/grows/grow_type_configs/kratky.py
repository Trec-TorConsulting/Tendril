...
KRATKY_STAGES: list[dict] = [
    # ── 1. GERMINATION ────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            ...
            {
                "name": "Prepare Kratky container",
                "description": "Fill opaque container with plain pH'd water (5.8). Set water level to just touch the bottom of the net pot. NO air stone — leave the lid sealed tight.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Outdoor Kratky must start after last frost. Photoperiod plants flower when daylight drops below ~14 hours. In northern hemisphere, start seeds indoors in April-May for outdoor transplant in May-June.",
                        "interval_days": None,
                        "priority": "high",
                    },
                ],
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Beneficial bacteria — critical in stagnant Kratky water. Prevents root rot without aeration.",
                },
            ],
        },
        "tasks": [
            {
                ...
                "description": "Verify water is touching net pot bottom. Seedling roots are short and need direct contact. Once roots are 2+ inches into water, the air gap can begin forming.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Mark initial water line",
                "description": "Use a marker to draw a line on the outside of the container at the current water level. This is your 'never refill above' line. As water drops, mark the air root zone.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Check for root growth",
                "description": "Briefly lift the lid to check if roots are growing down through the net pot into the water. You should see white roots within 5-7 days.",
                "interval_days": 3,
                "priority": "high",
            },
            {
                "name": "Monitor pH",
                "description": "pH tends to drift UP in Kratky (no aeration stabilizing it). Check every 2-3 days. Adjust with pH Down if above 6.2.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Ensure container is sealed and dark",
                "description": "Check for light leaks around the lid and net pot. Stagnant water + light = algae explosion. Cover any gaps with tape or neoprene collar.",
                "interval_days": None,
                "priority": "high",
            },
        ],
        ...
        "common_problems": [
            {
                ...
                "cause": "Water level too low or Rapid Rooter dried out",
                "solution": "Raise water level to just touch the bottom of the net pot. Use a wick (strip of felt or cotton) from the net pot down to the water to bridge the gap.",
            },
            {
                "issue": "Algae forming on water surface",
                "cause": "Light leaking into container through gaps",
                "solution": "Seal ALL light leaks. Cover net pot gap with neoprene collar or hydroton. Use opaque/black container. Algae competes with roots for oxygen in stagnant water — more dangerous in Kratky than DWC.",
            },
            {
                "issue": "Foul smell from container",
                "cause": "Anaerobic bacteria in stagnant water",
                "solution": "Drain, clean, refill with fresh pH'd nutrient solution + Hydroguard. Ensure container is sealed properly. This is the biggest Kratky risk — no aeration means anaerobic bacteria can establish quickly.",
            },
            {
                "issue": "pH rising rapidly",
                "cause": "Normal Kratky behavior — no aeration to stabilize pH",
                "solution": "Adjust with small amounts of pH Down. In Kratky, pH naturally drifts up. Check every 2-3 days. Don't over-correct.",
            },
        ],
        "training": [],
        "transition_signals": [
            "2-3 sets of true leaves",
            "Roots visible 2+ inches below net pot",
            "Air gap beginning to form (water level has dropped 1+ inch)",
            "Seedling drinking noticeably",
        ],
        "environment_variants": {
            "outdoor": {
                "environment_overrides": {
                ...
                "extra_tasks": [
                    {
                        "name": "Begin hardening off (end of stage)",
                        "description": "Start exposing seedling to outdoor conditions gradually. Day 1-2: 1 hour morning sun. Day 3-4: 2-3 hours. Day 5-7: 4-6 hours. Bring inside at night.",
                        "interval_days": 1,
                        "priority": "medium",
                    },
                    {
                        "name": "Insulate container for outdoor use",
                        "description": "Wrap Kratky container in Reflectix or white material. Outdoor sun heats containers much faster with no circulation to dissipate heat.",
                        "interval_days": None,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Container overheating in sun",
                        "cause": "Stagnant Kratky water heats up faster than aerated DWC water",
                        "solution": "Insulate container. Keep in shade while plant gets partial sun. Bury lower half in ground. Kratky without aeration is more sensitive to heat — above 75°F water promotes bacteria.",
                    },
                ],
            ...
            "greenhouse": {
                ...
                "extra_tasks": [
                    {
                        "name": "Shade the container",
                        "description": "Place the container where it gets shade even though the plant gets light. Kratky containers must stay cool — no circulation to manage heat.",
                        "interval_days": None,
                        "priority": "medium",
                    },
                ],
    ...
    # ── 3. EARLY VEGETATIVE ───────────────────────────────────────────────
    {
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Essential in stagnant Kratky water. Add at initial fill AND every top-off.",
                },
                {
                    "name": "Silica (Armor Si)",
                    "dose_ml_per_gal": 1.0,
                    "purpose": "Strengthens cell walls. Add first, before other nutrients. Especially useful in Kratky where roots have less oxygen support.",
                },
            ],
        },
        "tasks": [
            {
                "name": "Check water level & air gap",
                "description": "Verify the air gap is growing. Mark the current water line. You should see fuzzy air roots above the water and white water roots below. Both are healthy.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Monitor pH",
                "description": "pH drifts up in Kratky. Check every 2-3 days. Adjust gently with pH Down. Large swings are worse than slightly high pH. Range 5.5-6.5 is acceptable.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "First top-off (if needed)",
                "description": "If water level has dropped more than 50% of original volume, top off to halfway between current level and the lowest air roots. Use half-strength nutrients + Hydroguard. Mark the new 'never fill above' line.",
                "interval_days": None,
                "priority": "medium",
            },
            {
                "name": "Inspect roots",
                "description": "Briefly lift lid. Healthy Kratky roots: white/cream water roots below waterline, fuzzy lateral air roots above. Bad signs: brown slime, foul smell, mushy roots.",
                "interval_days": 4,
                "priority": "high",
            },
            {
                "name": "Begin LST training",
                "description": "Low Stress Training is ideal for Kratky. Bend and tie branches to spread the canopy. More even light = better yields without pushing the root system harder.",
                "interval_days": 3,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "No air roots forming",
                "cause": "Water level hasn't dropped enough or container isn't sealed (humidity escaping)",
                "solution": "Ensure lid is sealed tightly. The air gap must be humid (near 100% RH inside the container). If water hasn't dropped, the plant may be too small — give it time.",
            },
            {
                "issue": "Air roots dying/drying out",
                "cause": "Container lid not sealed — humid air escaping",
                "solution": "Seal the container better. Air roots need humid air (near 100% RH). If the container breathes, the air gap dries out and air roots die. Use tape or gasket material around the lid.",
            },
            {
                "issue": "Root rot in stagnant water",
                "cause": "Water too warm, no Hydroguard, organic debris",
                "solution": "Keep water below 72°F. Add Hydroguard at 2 ml/gal. Remove any dead plant material from water. In severe cases, do a full water change (this breaks pure Kratky philosophy but saves the plant).",
            },
            {
                "issue": "pH climbing above 6.5",
                "cause": "Normal Kratky pH drift — nutrient uptake creates alkaline byproducts",
                "solution": "Add pH Down carefully. Phosphoric acid-based pH Down also adds phosphorus. Don't chase pH — a slow drift from 5.8 to 6.5 over a week is acceptable. Only correct if above 6.5.",
            },
        ],
        "training": [
            {
                "method": "LST (Low Stress Training)",
                "description": "Bend main stem and tie to container edge or use plant clips. Opens canopy for even light. Start when plant has 4-5 nodes. Ideal for Kratky — doesn't stress the root system.",
                "when": "4-5 nodes, when stem is still flexible",
            },
            {
                "method": "Topping",
                "description": "Cut the main stem above the 4th or 5th node. Creates two main colas. Let plant recover for 5-7 days before additional training. Topping is fine in Kratky — the root system handles it.",
                "when": "5-6 nodes, healthy growth",
            },
        ],
        "transition_signals": [
            "Plant has 5-6+ nodes",
            "Air gap is 3-5+ inches",
            "Distinct air root and water root zones visible",
        ...
        "environment_variants": {
            "outdoor": {
                ...
                "extra_tasks": [
                    {
                        "name": "Insulate & shade container",
                        "description": "Wrap in Reflectix. Keep container in shade while plant gets sun. Bury lower half in ground. Kratky has zero tolerance for overheated water — no bubbles to add oxygen.",
                        "interval_days": None,
                        "priority": "critical",
                    },
                    {
                        "name": "Pest scouting",
                        "description": "Check for aphids, spider mites, caterpillars, slugs. Outdoor grows face constant pest pressure. Inspect both sides of leaves.",
                        "interval_days": 2,
                        "priority": "high",
                    },
                    {
                        "name": "Rain protection for container",
                        "description": "Cover the gap around the stem and net pot. Rain diluting the reservoir is worse in Kratky — you can't just 'change the res' without disrupting the air gap.",
                        "interval_days": None,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Stagnant water going anaerobic in heat",
                        "cause": "No aeration + warm temps = bacteria bloom",
                        "solution": "If water smells bad, do an emergency change. Refill to the air root line (NOT to top). Add extra Hydroguard (3 ml/gal). Insulate better. If chronic, consider adding a small solar-powered air pump (breaks pure Kratky but saves the plant).",
                    },
                    {
                        "issue": "Wind toppling container",
                        "cause": "As water level drops, container gets top-heavy",
                        "solution": "Place rocks or weights at the base. Use a wider, lower-profile container (storage tote vs tall bucket). Anchor to the ground.",
                    },
                ],
            ...
            "greenhouse": {
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Open vents when temp exceeds 80°F. Kratky water has no aeration buffer — the whole system depends on stable temps.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                    {
                        "name": "Check for greenhouse pests",
                        "description": "Greenhouses attract whiteflies, fungus gnats, and spider mites. Use sticky traps. Fungus gnats are especially attracted to stagnant Kratky water surfaces.",
                        "interval_days": 3,
                        "priority": "medium",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Fungus gnats in Kratky container",
                        "cause": "Stagnant water surface attracts egg-laying gnats",
                        "solution": "Seal container lid completely — no gaps. Add a layer of hydroton on top of net pot. Use yellow sticky traps. Mosquito dunks (BTI) in the water are safe and effective.",
                    },
                ],
    ...
    # ── 4. LATE VEGETATIVE ────────────────────────────────────────────────
    {
        ...
        "nutrients": {
            ...
            "supplements": [
                {"name": "Hydroguard", "dose_ml_per_gal": 2, "purpose": "Every top-off. Non-negotiable in Kratky."},
                {
                    "name": "Silica (Armor Si)",
                    "dose_ml_per_gal": 1.5,
                    "purpose": "Strengthens stems for heavy flower. Add first before other nutrients.",
                },
            ],
        },
        "tasks": [
            {
                ...
                "description": "When water drops to 25-30% of container, add nutrient solution to halfway between current level and lowest air roots. Never submerge air roots. Add Hydroguard.",
                "interval_days": 3,
                "priority": "high",
            },
            {
                "name": "Check pH at top-off",
                "description": "Check pH of existing water before and after adding top-off. Adjust entire volume if needed. pH Down is your friend in Kratky.",
                "interval_days": 3,
                "priority": "high",
            },
            {
                "name": "Inspect roots",
                "description": "Healthy air roots: fuzzy, white/cream, branching laterally. Healthy water roots: white/cream, may be slightly stained from nutrients. Bad: brown mush, foul smell, slimy.",
                "interval_days": 5,
                "priority": "medium",
            },
            {
                "name": "Continue LST / training",
                "description": "Keep bending and tying new growth. In Kratky, an even canopy is even more important — you need maximum efficiency from a root system with less oxygen than DWC.",
                "interval_days": 3,
                "priority": "medium",
            },
            {
                "name": "Consider container upgrade",
                "description": "If using a 5-gal bucket and topping off daily, switch to a 10-gal tote. Larger reservoir = more stable pH/EC, less frequent top-offs, and more Kratky-like behavior.",
                "interval_days": None,
                "priority": "low",
            },
            {
                "name": "Plan for flower transition",
                "description": "Stop topping/training 1-2 weeks before planned flip. Let plant recover before the stretch.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "Water level dropping too fast (daily top-off)",
                "cause": "Container too small for the plant size",
                "solution": "Upgrade to a larger container (10-15 gal). Transplant carefully — keep the air root zone intact. Match the water level to the existing air gap line. Larger container = more stable system.",
            },
            {
                "issue": "EC rising in reservoir",
                "cause": "Plant drinking water faster than nutrients — evaporation concentrating salts",
                "solution": "Top off with PLAIN pH'd water (no nutrients) when EC is rising. Only add nutrients when EC is dropping. This is the same rule as DWC.",
            },
            {
                "issue": "EC dropping in reservoir",
                "cause": "Plant consuming nutrients faster than water",
                "solution": "Top off with full-strength nutrient solution. The plant is hungry. This usually means healthy, vigorous growth.",
            },
            {
                "issue": "Air roots turning brown/dying",
                "cause": "Container not sealed — humid air escaping, or water level rose above air roots during top-off",
                "solution": "Check seal on container lid. NEVER top off above the air root zone. If you accidentally submerged air roots, drain water back down immediately. Air roots that were submerged may die but new ones will form.",
            },
            {
                "issue": "Thick biofilm on water surface",
                "cause": "Stagnant water + warm temps + organic matter",
                "solution": "Carefully remove biofilm with a paper towel. Add extra Hydroguard. If severe, do a full reservoir change — fill to the existing air gap line, not to top. Add Hydroguard immediately.",
            },
        ],
        "training": [
            {
                "method": "LST (Low Stress Training)",
                "description": "Continue bending and tying. Kratky plants benefit more from LST than DWC — the root system has less oxygen support, so keeping an efficient canopy matters more.",
                "when": "Ongoing throughout veg",
            },
            {
                "method": "SCROG (Screen of Green)",
                "description": "Install trellis net 8-12 inches above container. Tuck branches under net as they grow through. Excellent for Kratky — maximizes yield per plant.",
                "when": "2-3 weeks before flip",
            },
            {
                "method": "Defoliation (light)",
                "description": "Remove lower leaves and small branches that won't reach the canopy. Redirect energy to top growth. Don't overdo it — the plant needs leaves to drink and drive the Kratky cycle.",
                "when": "1 week before flip",
            },
        ],
        "transition_signals": [
            ...
            "Root system is well-established with healthy air and water roots",
        ],
        "environment_variants": {
            "outdoor": {
                "environment_overrides": {
                ...
                "extra_tasks": [
                    {
                        "name": "Top off daily (or twice daily in heat)",
                        "description": "Large outdoor Kratky plants drink fast. Check morning and evening. Never let the water level reach zero — the water roots will die. Maintain at least 2 inches of water at all times.",
                        "interval_days": 0.5,
                        "priority": "critical",
                    },
                    {
                        "name": "Structural support",
                        "description": "Outdoor Kratky plants grow tall. Install a tomato cage, bamboo stakes, or trellis. The container gets lighter as water drops — brace it.",
                        "interval_days": None,
                        "priority": "high",
                    },
                    {
                        "name": "IPM spray (preventive)",
                        "description": "Apply neem oil or insecticidal soap every 7-10 days during veg. Stop all sprays 2+ weeks before flower.",
                        "interval_days": 7,
                        "priority": "medium",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Container runs dry",
                        "cause": "Hot day, large plant, missed top-off",
                        "solution": "Refill immediately to the air gap line. If water roots dried for less than a few hours, the plant will recover. If the air gap dried out too, mist the air roots to rehydrate. Prevention: use the largest container possible.",
                    },
                    {
                        "issue": "Animal damage",
                        "cause": "Deer, rabbits, or rodents",
                        "solution": "Fence or chicken wire around the plant. Container is portable — move to sheltered area if needed.",
                    },
                ],
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Install blackout tarps if you want to control flowering time. 12 hours of uninterrupted darkness required. Must be done consistently every day.",
                        "interval_days": None,
                        "priority": "medium",
                    },
                    {
                        "name": "Manage greenhouse heat",
                        "description": "Shade cloth, exhaust fans, open vents. Kratky water temps must stay below 72°F — monitor closely in summer.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Missing coverage interrupts the dark period",
                        "solution": "Automate with motorized tarps. One missed day can revert to veg or cause hermaphroditism.",
                    },
                ],
    ...
    # ── 5. TRANSITION (Pre-Flower / Stretch) ─────────────────────────────
    {
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Every top-off and reservoir swap. Non-negotiable.",
                },
                {
                    "name": "Silica (Armor Si)",
                    "dose_ml_per_gal": 1.5,
                    "purpose": "Last week to add silica — stop before mid-flower.",
                },
            ],
        },
        "tasks": [
            {
                "name": "Flip light schedule to 12/12",
                "description": "Set timer to 12 hours on / 12 hours off. Ensure complete darkness during off period — check for indicator lights, light leaks, and timer reliability.",
                "interval_days": None,
                "priority": "critical",
            },
            {
                "name": "Consider full reservoir swap",
                "description": "Drain existing veg solution down to just above the water roots (keeping air gap intact). Refill to the air root line with bloom-ratio nutrients + Hydroguard. This gives a clean nutritional start for flower.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Top off frequently (stretch demand)",
                "description": "Plant may drink 1-2+ gal/day during stretch. Check water level daily. Top off with bloom-ratio nutrients below the air root zone. Add Hydroguard to every top-off.",
                "interval_days": 1,
                "priority": "high",
            },
            {
                "name": "Support stretching branches",
                "description": "The stretch can double plant height. Use plant ties, bamboo stakes, or trellis net. Branches that aren't supported will bend or break under future bud weight.",
                "interval_days": 2,
                "priority": "medium",
            },
            {
                "name": "Lollipop bottom growth",
                "description": "Remove small lower branches and leaves that won't get light. This redirects energy to top colas. In Kratky, efficiency matters — the root system has less oxygen support than DWC.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "Water runs out overnight",
                "cause": "Heavy stretch drinking + undersized container",
                "solution": "Top off to the air root line before lights out. If this keeps happening, upgrade to a larger container. Emergency: refill to air root line immediately. Roots that dry out completely will die.",
            },
            {
                "issue": "Hermaphrodite signs (bananas/nanners)",
                "cause": "Light leak during dark period, or stress from dried-out roots",
                "solution": "Check for ANY light leaks. If you must open the container during dark period for top-off, use a green headlamp only. If hermie is confirmed, remove pollen sacs immediately.",
            },
            {
                "issue": "Nutrient burn (brown leaf tips)",
                "cause": "Concentrated nutrients from evaporation or too-strong mix",
                "solution": "Top off with plain pH'd water (no nutrients) until EC drops. Kratky concentrates nutrients as water evaporates — monitor EC at every top-off.",
            },
        ],
        "training": [
            {
                "method": "Final SCROG tucking",
                "description": "Tuck branches under the trellis net as they stretch through. Keep canopy even. Stop tucking once buds start forming (usually end of week 2 of 12/12).",
                "when": "First 2 weeks of 12/12",
            },
            {
                "method": "Supercropping (advanced)",
                "description": "Gently crush and bend tall branches to even the canopy without cutting. Creates a knuckle that strengthens the branch. Use carefully — Kratky plants may recover slower than DWC due to less oxygen.",
                "when": "During stretch for branches outgrowing the canopy",
            },
        ],
        "transition_signals": [
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Ensure no artificial light reaches the plant during dark hours. Move container if needed — Kratky containers are portable.",
                        "interval_days": None,
                        "priority": "critical",
                    },
                    {
                        "name": "Final pest prevention",
                        "description": "Last chance for preventive sprays. Apply BT (Bacillus thuringiensis) for caterpillars. After buds form, no more spraying.",
                        "interval_days": None,
                        "priority": "high",
                    },
                    {
                        "name": "Reinforce supports",
                        "description": "Stretch + future bud weight requires strong support. Add stakes, cage, or trellis.",
                        "interval_days": None,
                        "priority": "high",
                    },
                    {
                        "name": "Top off twice daily",
                        "description": "Outdoor stretch in summer heat = peak water demand. Check morning and evening. Never let water level reach zero.",
                        "interval_days": 0.5,
                        "priority": "critical",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Street lights or porch lights nearby",
                        "solution": "Move the container to a darker location. Kratky portability is an advantage here.",
                    },
                    {
                        "issue": "Container runs dry in heat",
                        "cause": "Stretch + high temps + no aeration cooling",
                        "solution": "Top off immediately. Use a larger container (15+ gal). Add frozen water bottles to cool the refill water.",
                    },
                ],
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Cover greenhouse at the same time every evening. 12 hours of TOTAL darkness. Even small light leaks through tarp edges matter.",
                        "interval_days": 1,
                        "priority": "critical",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "solution": "Cover in evening when temps drop. Ensure some passive ventilation under the tarp. Kratky water temps spike in trapped heat.",
                    },
                ],
    ...
    # ── 6. EARLY FLOWER ───────────────────────────────────────────────────
    {
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Every top-off. Stagnant flower-stage water is nutrient-rich and warm — prime rot conditions.",
                },
                {
                    "name": "Liquid Koolbloom (optional)",
                    "dose_ml_per_gal": 1.25,
                    "purpose": "PK booster for early flower. Increases bud density. Use for first 3-4 weeks of flower only.",
                },
            ],
        },
        "tasks": [
            {
                "name": "Top off with bloom nutrients",
                "description": "Check water level every 1-2 days. Top off below air roots with bloom-ratio nutrients. Check EC first — if rising, use plain water. If dropping, use nutrients.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Monitor EC carefully",
                "description": "Kratky concentrates nutrients as water evaporates. EC above 1.8 = too concentrated. Dilute by topping off with plain pH'd water. EC below 0.8 = plant is hungry, top off with full-strength nutrients.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Defoliation (targeted)",
                "description": "Remove fan leaves that are blocking light to bud sites. Don't remove more than 20% of leaves at once. Kratky plants recover from defoliation slower than DWC — be conservative.",
                "interval_days": None,
                "priority": "medium",
            },
            {
                "name": "Inspect for bud rot",
                "description": "Check dense bud sites for any gray/brown rot. Bud rot in Kratky grows can be worse because the grower is already fighting humidity from the stagnant reservoir. Good airflow is critical.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Support heavy buds",
                "description": "Use plant yoyos, string, or bamboo to support branches as buds gain weight. Kratky containers lose weight as water drops — anchor the container too.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "Nutrient concentration (EC climbing)",
                "cause": "Water evaporating faster than plant drinks — concentrating salts in stagnant reservoir",
                "solution": "Top off with plain pH'd water only until EC drops to target range. In Kratky, evaporation concentration is more severe than DWC because there's no water movement.",
            },
            {
                "issue": "Bud rot starting",
                "cause": "Humidity too high, poor airflow, dense buds",
                "solution": "Remove affected bud + 1 inch of healthy tissue. Increase airflow with fans. Lower humidity below 50%. In Kratky, the sealed container adds ambient humidity to the grow space — ensure good room ventilation.",
            },
            {
                "issue": "Root zone smell during flower",
                "cause": "Nutrient-rich stagnant water + warm temps",
                "solution": "Add extra Hydroguard (3 ml/gal for one top-off). If smell is severe, do a partial water swap: drain to just above water roots, refill with fresh bloom nutrients to the air gap line. Add Hydroguard immediately.",
            },
        ],
        "training": [],
        "transition_signals": [
        ...
        "environment_variants": {
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "After rain, shake water off buds. Inspect for gray mold within 24-48 hours. Kratky moisture + rain = double humidity risk.",
                        "interval_days": None,
                        "priority": "critical",
                    },
                    {
                        "name": "Caterpillar patrol (BT spray)",
                        "description": "Budworms bore into buds and cause rot from inside. Inspect for frass (dark droppings). Apply BT if found — safe up to harvest.",
                        "interval_days": 3,
                        "priority": "critical",
                    },
                    {
                        "name": "Shake off morning dew",
                        "description": "Gently shake plant each morning to remove dew from buds.",
                        "interval_days": 1,
                        "priority": "medium",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Water trapped in dense buds + stagnant Kratky humidity",
                        "solution": "Cut affected area + 1 inch. Improve airflow. Consider harvesting early if persistent rain is forecast.",
                    },
                    {
                        "issue": "Caterpillar damage",
                        "cause": "Moths lay eggs on buds",
                        "solution": "Apply BT (Bacillus thuringiensis). Check buds for frass. Remove affected buds by hand.",
                    },
                    {
                        "issue": "Early frost threat",
                        "cause": "Fall temperatures dropping",
                        "solution": "Cover with frost cloth at night. Move Kratky container to shelter — portability is a key advantage.",
                    },
                ],
            ...
            "greenhouse": {
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Open vents during day. Run HAF fans constantly. Use dehumidifier if RH consistently above 55% during flower. Kratky sealed containers contribute moisture.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Condensation on glazing dripping on buds",
                        "cause": "Temperature differential + Kratky humidity contribution",
                        "solution": "Increase air circulation. Open vents briefly in morning. Consider anti-drip greenhouse film.",
                    },
                ],
    ...
    # ── 7. MID/PEAK FLOWER (Bulk Phase) ──────────────────────────────────
    {
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Every top-off. Bloom-stage water is nutrient-rich and perfect for bacteria — Hydroguard keeps the good ones dominant.",
                },
                {
                    "name": "Liquid Koolbloom (optional)",
                    "dose_ml_per_gal": 1.25,
                    "purpose": "PK booster through mid-flower. Stop 2 weeks before harvest.",
                },
            ],
        },
        "tasks": [
            {
                "name": "Routine top-off",
                "description": "By now you know the drinking pattern. Top off on schedule. Check EC first: rising = plain water, dropping = nutrients. Add Hydroguard every time.",
                "interval_days": 2,
                "priority": "high",
            },
            {
                "name": "Check trichomes weekly",
                "description": "Use jeweler's loupe or digital microscope. Clear = not ready. Milky/cloudy = peak THC. Amber = more CBN (couch-lock). Most growers harvest at mostly milky with 10-20% amber.",
                "interval_days": 7,
                "priority": "medium",
            },
            {
                "name": "Remove yellowing fan leaves",
                "description": "Lower fan leaves naturally yellow as the plant redirects nutrients to buds. Remove them to improve airflow and prevent rot. This is normal.",
                "interval_days": 3,
                "priority": "low",
            },
            {
                "name": "Monitor for pests",
                "description": "Flower stage attracts thrips and spider mites. In Kratky, fungus gnats are attracted to the container's moisture. Check undersides of leaves and bud sites.",
                "interval_days": 3,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "Foxtailing (buds growing wispy towers)",
                "cause": "Light too close / too intense, or heat stress",
                "solution": "Raise light 2-4 inches. Check leaf surface temperature. In Kratky, root stress from warm stagnant water can compound heat stress from above — fix both.",
            },
            {
                "issue": "Salt buildup in reservoir",
                "cause": "Weeks of top-offs concentrating mineral salts in stagnant water",
                "solution": "If EC is chronically high (above 2.0), do a partial water swap: drain to just above water roots, refill to air gap line with half-strength bloom nutrients + Hydroguard. This resets salt levels.",
            },
            {
                "issue": "Slow bud development",
                "cause": "Insufficient light, low P/K, or root issues",
                "solution": "Check light intensity (target 800+ PPFD). Ensure bloom nutrients are heavy on P and K. Inspect roots — if brown and smelly, root health is compromising nutrient uptake. Add Hydroguard and consider a water swap.",
            },
        ],
        "training": [],
        "transition_signals": [
        ...
        "environment_variants": {
            "outdoor": {
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Check 10-day forecast daily. If prolonged rain is coming and buds are close to ready, consider early harvest. Move Kratky container under cover for rain events.",
                        "interval_days": 1,
                        "priority": "critical",
                    },
                    {
                        "name": "Rain cover / move container",
                        "description": "When rain is forecast, move the Kratky container under an overhang, carport, or tarp. The plant can handle a day of lower light — it can't handle bud rot.",
                        "interval_days": None,
                        "priority": "high",
                    },
                    {
                        "name": "Caterpillar patrol continues",
                        "description": "Caterpillars are still active. Check daily — their damage causes bud rot from inside.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Multi-day rain during peak flower",
                        "cause": "Fall weather patterns",
                        "solution": "Move container to covered area. Kratky's biggest advantage is portability. A slightly early harvest beats a moldy crop.",
                    },
                    {
                        "issue": "Cool nights below 50°F",
                        "cause": "Fall approaching",
                        "solution": "Move container indoors at night. Cool enhances colors but below 40°F risks damage. Kratky portability is the key advantage here.",
                    },
                ],
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "If overnight greenhouse temps drop below 55°F, use a small space heater. Kratky water will also cool down — check water temp.",
                        "interval_days": 1,
                        "priority": "medium",
                    },
                ],
    ...
    # ── 8. LATE FLOWER / RIPENING ─────────────────────────────────────────
    {
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Continue until flush. Root protection doesn't stop.",
                },
            ],
        },
        "tasks": [
            {
                "name": "Check trichomes (daily now)",
                "description": "Trichome maturity determines harvest timing. Watch for milky → amber transition. Your target amber percentage is personal preference: 10% amber = energetic high, 30% = more sedative.",
                "interval_days": 1,
                "priority": "critical",
            },
            {
                "name": "Reduced top-offs",
                "description": "Plant drinks less as it finishes. Top off less frequently but still maintain water above the root zone. Never let roots dry completely.",
                "interval_days": 3,
                "priority": "medium",
            },
            {
                "name": "Remove dead/dying fan leaves",
                "description": "The natural fade accelerates. Yellow and dead fan leaves can fall into the reservoir — remove them. In Kratky, organic debris in stagnant water is especially problematic.",
                "interval_days": 2,
                "priority": "medium",
            },
            {
                "name": "Plan flush timing",
                "description": "Most growers flush 7-14 days before harvest. In Kratky, flush = drain to above water roots, refill to air gap line with plain pH'd water. Mark your calendar.",
                "interval_days": None,
                "priority": "high",
            },
        ],
        ...
        "common_problems": [
            {
                "issue": "Buds not finishing (still throwing white pistils)",
                "cause": "Strain is slow, light leaks, or environmental stress",
                "solution": "Check for light leaks. Some strains take 10-12 weeks. If light leak is causing re-vegging, fix immediately. Patience.",
            },
            {
                "issue": "Excessive leaf yellowing too early",
                "cause": "Nutrient deficiency or too much flushing too soon",
                "solution": "If trichomes aren't ready yet, don't start flushing. Maintain light feeding. The fade should be gradual, not sudden.",
            },
            {
                "issue": "Nutrient taste concern",
                "cause": "Salts accumulated in stagnant Kratky water over weeks",
                "solution": "A proper flush (7-14 days of plain water) resolves this. Kratky actually makes flushing easy — just swap the water and let the plant finish.",
            },
        ],
        "training": [],
        "transition_signals": [
        ...
        "environment_variants": {
            "outdoor": {
                ...
                "extra_tasks": [
                    {
                        "name": "Frost watch",
                        "description": "Monitor forecasts for first frost. Move Kratky container inside overnight if temps below 45°F. A hard freeze kills the plant and ruins buds.",
                        "interval_days": 1,
                        "priority": "critical",
                    },
                    {
                        "name": "Daily bud rot check",
                        "description": "Cool, damp fall mornings are prime bud rot conditions. Check every dense cola daily.",
                        "interval_days": 1,
                        "priority": "critical",
                    },
                    {
                        "name": "Move container inside at night",
                        "description": "If nighttime temps drop below 45°F, bring the Kratky container inside a garage or shed overnight. This is the #1 advantage of Kratky over DWC — true portability.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Growing season too short",
                        "solution": "Harvest immediately before frost. Next season, choose faster-finishing strains or start earlier. Autoflowers avoid this problem entirely.",
                    },
                    {
                        "issue": "Persistent damp/fog",
                        "cause": "Fall weather patterns",
                        "solution": "Move container to drier area. Increase airflow. Consider early harvest of lower buds while tops finish.",
                    },
                ],
            ...
            "greenhouse": {
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Thermostat-controlled heater set to 55°F minimum overnight. Kratky water also cools — check water temp.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                    {
                        "name": "End-of-season humidity watch",
                        "description": "Fall greenhouse humidity rises. Run dehumidifier or ventilate during warmest part of day.",
                        "interval_days": 1,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        "issue": "Greenhouse condensation on buds",
                        "cause": "Warm inside, cool outside = condensation",
                        "solution": "Ventilate briefly each morning. Use HAF fans. Anti-drip greenhouse film helps.",
                    },
                ],
            ...
            "supplements": [
                {
                    "name": "Hydroguard",
                    "dose_ml_per_gal": 2,
                    "purpose": "Root protection even during flush. Stagnant water still needs beneficial bacteria.",
                },
                {
                    "name": "FloraKleen (optional)",
                    "dose_ml_per_gal": 2.5,
                    "purpose": "Flushing agent that dissolves residual mineral salts. Especially useful in Kratky where salts accumulate over the grow.",
                },
            ],
        },
        "tasks": [
            {
                ...
                "description": "Carefully drain nutrient solution to just above water roots (don't disturb air roots). Refill to the air gap line with plain pH'd water (5.8) + Hydroguard. Mark the water line.",
                "interval_days": 5,
                "priority": "high",
            },
            {
                "name": "Monitor trichomes (daily)",
                "description": "Continue daily trichome checks. Harvest when ratio is where you want it. Don't extend flush past 14 days — diminishing returns.",
                "interval_days": 1,
                "priority": "critical",
            },
            {
                "name": "Prepare harvest equipment",
                "description": "Clean trimming scissors, set up drying area, prepare drying rack/lines. Ensure drying space can maintain 60°F / 60% RH in darkness.",
                "interval_days": None,
                "priority": "medium",
            },
            {
        ...
        "common_problems": [
            {
                ...
                "solution": "No action needed. This is expected and desired. The yellowing and fading IS the flush working.",
            },
            {
                "issue": "Foul smell from reservoir during flush",
                "cause": "Stagnant plain water + decomposing root material",
                "solution": "Do more frequent water changes (every 3 days instead of 5). Add extra Hydroguard. Remove any fallen leaves from the water.",
            },
        ],
        "training": [],
        "transition_signals": [
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "If a hard frost, multi-day rain, or storm is forecast within 3-5 days, harvest now regardless of flush status. Move container inside for the flush if weather is marginal.",
                        "interval_days": 1,
                        "priority": "critical",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "solution": "Harvest immediately. A shorter flush won't noticeably affect quality — but mold will ruin everything.",
                    },
                ],
    ...
    # ── 10. HARVEST ───────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {
                ...
                "description": "Cut main stem at base. If wet trimming, trim fan leaves and sugar leaves immediately. If dry trimming, leave sugar leaves on for slower, higher-quality dry.",
                "interval_days": None,
                "priority": "critical",
            },
            {
                "name": "Remove from Kratky container",
                "description": "Pull net pot from container. No air stone or pump to disconnect — just lift and drain. The root mass (both air roots and water roots) will be impressive.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Clean container for next grow",
                "description": "Drain all water. Scrub container and lid with hydrogen peroxide or dilute bleach solution. Rinse thoroughly. Kratky containers accumulate more mineral deposits than DWC — soak in vinegar solution to dissolve.",
                "interval_days": None,
                "priority": "medium",
            },
            {
            ...
            },
            {
                ...
                "description": "Note: date, wet weight, days in flower, strain, trichome ratio, container size, total top-offs performed, any issues. This data improves future Kratky grows.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            ...
            {
                "issue": "Root mass stuck in container",
                "cause": "Roots grew through net pot and anchored to container walls",
                "solution": "Gently work the root mass free. Kratky air roots can grip container walls. If stuck, cut roots near the wall — you're done growing anyway.",
            },
        ],
        "training": [],
                ...
                "extra_tasks": [
                    {
                        ...
                        "description": "Outdoor plants are best harvested at first light, before the sun warms terpenes. Cooler temps preserve trichome quality.",
                        "interval_days": None,
                        "priority": "medium",
                    },
                    {
                        "name": "Clean container for storage",
                        "description": "Scrub, sanitize, and store container for next season. Kratky containers need thorough cleaning — stagnant water leaves more mineral deposits.",
                        "interval_days": None,
                        "priority": "low",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Outdoor buds may contain insects or eggs",
                        "solution": "Bud washing: dip branches in 3 buckets — H2O2 solution, lemon juice + baking soda water, plain water rinse. Shake off excess and hang.",
                    },
                ],
    ...
    # ── 11. DRYING ────────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {
                "name": "Hang buds to dry",
                "description": "Hang branches on drying lines or use a drying rack. Space buds so air circulates between them. Darkness is essential — light degrades THC.",
                "interval_days": None,
                "priority": "critical",
            },
            {
                "name": "Monitor temperature and humidity",
                "description": "60°F/60% RH target. Use humidifier if too dry, dehumidifier if too humid. Small adjustments matter. Check twice daily.",
                "interval_days": 0.5,
                "priority": "high",
            },
            {
                "name": "Check drying progress",
                "description": "After day 5, start checking daily. Small stems should snap (not bend). Buds should feel dry on outside but slightly spongy when squeezed. Don't over-dry.",
                "interval_days": 1,
                "priority": "high",
            },
            {
                "name": "Maintain gentle airflow",
                "description": "Use a small fan pointed at the wall (not at buds). Air should circulate without directly blowing on buds. No oscillating fans aimed at drying buds.",
                "interval_days": None,
                "priority": "medium",
            },
        ],
        ...
        "common_problems": [
            ...
            },
            {
                ...
                "cause": "Dried too fast — chlorophyll didn't break down",
        ...
        "environment_variants": {
            "outdoor": {
                ...
                "extra_tasks": [
                    {
                        "name": "Bud wash before hanging (recommended)",
                        "description": "Dip harvested branches in 3 buckets: 1) H2O2 solution, 2) lemon + baking soda water, 3) plain rinse. Shake off excess and hang. Removes outdoor contaminants.",
                        "interval_days": None,
                        "priority": "high",
                    },
                ],
                "extra_problems": [
                    {
                        ...
                        "cause": "Home heating system drying the air",
                        "solution": "Use a room away from heating vents. Add a humidifier. Monitor closely.",
                    },
                ],
    ...
    # ── 12. CURING ────────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {
                "name": "Jar buds",
                "description": "Place dried buds loosely in wide-mouth mason jars (fill 75% full). Don't pack tight — buds need air space. Close lids.",
                "interval_days": None,
                "priority": "critical",
            },
            {
                "name": "Burp jars (week 1-2)",
                "description": "Open jars for 5-15 minutes, 2-3 times per day for first 2 weeks. This releases moisture and prevents mold. If buds feel wet, leave jars open for 1 hour.",
                "interval_days": 0.5,
                "priority": "high",
            },
            {
                "name": "Burp jars (week 3-4)",
                "description": "Reduce burping to once per day for 5-10 minutes. Buds should feel consistently dry on outside.",
                "interval_days": 1,
                "priority": "medium",
            },
            {
                "name": "Long-term cure (week 5+)",
                "description": "Burp once per week. Add Boveda 62% pack for hands-off humidity control. Buds continue improving for months. Peak quality at 6-8 weeks.",
                "interval_days": 7,
                "priority": "low",
            },
        ],
    ...
    # ── 13. STORAGE ──────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            {
                ...
                "description": "Home: mason jars with Boveda 58-62% packs. Commercial: nitrogen-sealed grove bags, CVault containers, or nitrogen-flushed drums for bulk. Remove oxygen — it degrades cannabinoids.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Label and track batches",
                "description": "Strain, harvest date, storage date, weight, batch number. Commercial: full seed-to-sale tracking, FIFO rotation.",
                "interval_days": None,
                "priority": "high",
            },
            {
                "name": "Monthly quality checks",
                "description": "Inspect for mold, off odors. Check humidity packs. Spot-check trichomes (amber increase = degradation). Commercial: potency/terpene testing at 30/90/180 days.",
                "interval_days": 30,
                "priority": "high",
            },
            {
                "name": "Maintain environment",
                "description": "Monitor temp/humidity. No light leaks. Commercial: environmental monitoring with alerts.",
                "interval_days": 1,
                "priority": "high",
            },
            {
                "name": "Rotate stock (FIFO)",
                "description": "First in, first out. Flag batches approaching 12 months for priority sale or processing.",
                "interval_days": 30,
                "priority": "medium",
            },
            {
        ...
        "common_problems": [
            {
                ...
                "solution": "Ensure darkness, cool temps (60°F), minimal oxygen. ~5%/year loss is baseline under ideal conditions.",
            },
            {
                "issue": "Terpene loss",
            ...
            },
            {
                ...
                "solution": "Check humidity. Remove affected material. Ensure 58-62% RH before sealing.",
            },
            {
                "issue": "Weight loss",
                "cause": "Normal moisture equilibration (1-3% first month)",
                "solution": "Boveda packs minimize loss. Sealed containers reduce ongoing loss.",
            },
        ],
        "training": [],
        ...
        "environment_variants": {
            ...
            "greenhouse": {
                "environment_overrides": {"notes": "Do NOT store in greenhouse — temp swings."},
                "extra_tasks": [],
                "extra_problems": [],
                "notes": "Store in climate-controlled indoor space.",
            },
        },
        "commercial_scale": {
...
KRATKY_EQUIPMENT = [
    # ── Essential ─────────────────────────────────────────────────────────
    {
        "name": "Opaque Container (5-10 gal)",
        "category": "essential",
        "description": "Must be completely light-proof to prevent algae. Black or dark-colored buckets, totes, or storage bins. 5 gal for small plants, 10+ gal for large. No transparent or translucent containers — even white can let light through.",
    },
    {
        "name": "Net Pot (6 inch)",
        "category": "essential",
        "description": "Sits in lid opening. Holds the plant and growing medium above the reservoir. Must fit snugly in the container lid — no light gaps.",
    },
    {
        "name": "Container Lid (with net pot hole)",
        "category": "essential",
        "description": "Must seal tightly. Cut or drill a hole for the net pot. Seal all gaps — light entering the reservoir causes algae and root damage.",
    },
    {
        "name": "Hydroton / Clay Pebbles",
        "category": "essential",
        "description": "Inert growing medium in the net pot. Supports the plant and wicks moisture to young roots. Rinse thoroughly before use to remove dust.",
    },
    {
        "name": "pH Pen or Test Kit",
        "category": "essential",
        "description": "Accurate pH measurement is critical. Digital pen preferred (calibrate monthly). Liquid test kits work but are less precise. Target range: 5.5-6.2.",
    },
    {
        "name": "EC/TDS Meter",
        "category": "essential",
        "description": "Measures nutrient concentration. Essential for Kratky because stagnant water concentrates nutrients as it evaporates. Check EC at every top-off.",
    },
    {
        "name": "pH Up & pH Down",
        "category": "essential",
        "description": "GH pH Up (potassium hydroxide) and pH Down (phosphoric acid). Kratky pH drifts up over time — you'll use pH Down more often.",
    },
    {
        "name": "Nutrients (GH Flora Trio)",
        "category": "essential",
        "description": "FloraMicro, FloraGro, FloraBloom — 3-part nutrient system. Mix in order: Micro first, then Gro, then Bloom. Never mix concentrates directly together.",
    },
    {
        "name": "Hydroguard",
        "category": "essential",
        "description": "Beneficial bacteria (Bacillus amyloliquefaciens). CRITICAL for Kratky — no air pump means stagnant water. Hydroguard prevents root rot. 2 ml/gal at every fill and top-off. Non-negotiable.",
    },
    {
        "name": "Grow Light",
        "category": "essential",
        "description": "Full-spectrum LED recommended. Size depends on canopy area. Minimum 30 watts/sq ft actual draw for flower. Quantum boards (Samsung LM301B/H diodes) are efficient and cool-running.",
    },
    {
        "name": "Light Timer",
        "category": "essential",
        "description": "Reliable timer for photoperiod control. Digital preferred over mechanical. 18/6 for veg, 12/12 for flower. Timer failure during flower causes hermaphroditism.",
    },
    {
        "name": "Thermometer / Hygrometer",
        "category": "essential",
        "description": "Monitor air temp and humidity. Digital with min/max recording. Place at canopy level. Consider one with probe for reservoir water temp too.",
    },
    {
        "name": "Neoprene Collar / Seal",
        "category": "essential",
        "description": "Fills the gap between the plant stem and net pot opening. Blocks light from entering the reservoir. Also prevents evaporation and mosquito access. Kratky-specific essential item.",
    },
    # ── Recommended ───────────────────────────────────────────────────────
    {
        "name": "CalMag Supplement",
        "category": "recommended",
        "description": "Calcium and magnesium supplement. Needed with most LED lights and RO/soft water. 1-2 ml/gal depending on stage.",
    },
    {
        "name": "Rapid Rooters",
        "category": "recommended",
        "description": "Starter plugs for germination. Place seed in Rapid Rooter, then into net pot with hydroton when taproot emerges.",
    },
    {
        "name": "Water Thermometer",
        "category": "recommended",
        "description": "Separate thermometer for reservoir water. Kratky water temp creeps up because there's no air pump cooling. Keep 62-72°F.",
    },
    {
        "name": "Jeweler's Loupe (60x)",
        "category": "recommended",
        "description": "For checking trichome maturity during flower. 60x minimum magnification. Digital USB microscopes work even better.",
    },
    {
        "name": "Exhaust Fan + Carbon Filter",
        "category": "recommended",
        "description": "Odor control and air exchange. Essential if growing in a tent or enclosed space. Size to exchange room volume every 1-3 minutes.",
    },
    {
        "name": "Circulation Fan",
        "category": "recommended",
        "description": "Air movement strengthens stems and prevents mold. Don't blow directly on plants — aim at walls for indirect circulation.",
    },
    {
        "name": "Silica Supplement (Armor Si)",
        "category": "recommended",
        "description": "Strengthens cell walls and stems. Add first when mixing nutrients (before anything else). Stop during mid-to-late flower.",
    },
    {
        "name": "Marker / Tape for Water Lines",
        "category": "recommended",
        "description": "Mark the initial fill line and the air gap line on the container. Kratky-specific: knowing exactly where the air gap starts is critical for proper top-offs.",
    },
    {
        "name": "Syringe Set (1ml, 5ml, 10ml)",
        "category": "recommended",
        "description": "Accurate nutrient measurement. Small containers in Kratky mean small volumes — precision matters.",
    },
    # ── Optional ──────────────────────────────────────────────────────────
    {
        "name": "Wick Material (for seedling stage)",
        "category": "optional",
        "description": "Cotton rope or felt strip to bridge the gap between net pot bottom and water level during seedling stage. Keeps medium moist until roots reach the water. Remove once roots touch.",
    },
    {
        "name": "Frozen Water Bottles",
        "category": "optional",
        "description": "Drop into reservoir to lower water temp in hot conditions. Cheap alternative to a water chiller. Replace every 12 hours.",
    },
    {
        "name": "FloraKleen",
        "category": "optional",
        "description": "Flushing agent that dissolves mineral salt buildup. Useful in Kratky where salts accumulate over the grow cycle.",
    },
    {
        "name": "PK Booster (Liquid Koolbloom)",
        "category": "optional",
        "description": "Phosphorus/potassium booster for early-to-mid flower. Increases bud density. Use for 3-4 weeks then stop.",
    },
    {
        "name": "Trellis Net (SCROG)",
        "category": "optional",
        "description": "Support and canopy management. Stretch over the canopy at the start of flower. Tuck branches through during the stretch.",
    },
    {
        "name": "Plant Yoyos",
        "category": "optional",
        "description": "Retractable plant supports. Hook to branches and hang from above. Support heavy buds during flower.",
    },
    {
        "name": "Mason Jars + Boveda Packs (62%)",
        "category": "optional",
        "description": "Wide-mouth quart mason jars for curing. Boveda 62% packs maintain perfect humidity hands-free.",
    },
    {
        "name": "Backup Container + Lid",
        "category": "optional",
        "description": "If the reservoir develops issues (light leak, crack, smell), you can swap the net pot to a fresh container. Kratky makes this easy — just lift and move.",
    },
]
