...
DRIP_STAGES: list[dict] = [
    ...
    # ── 13. STORAGE ──────────────────────────────────────────────────────
    {
        ...
        "tasks": [
            ...
            {"name": "Label and track batches", "description": "Strain, harvest date, storage date, weight, batch number, crop steering profile used. Commercial: seed-to-sale, FIFO rotation.", "interval_days": None, "priority": "high"},
