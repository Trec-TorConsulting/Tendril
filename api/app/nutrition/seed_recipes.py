...
ORGANIC_RECIPES = [
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "ingredients": [
            {"name": "Quality compost / worm castings", "amount": "1/4", "unit": "cup per gallon", "notes": "Must be high-quality, earthy-smelling compost. Worm castings preferred."},
            {"name": "Unsulfured blackstrap molasses", "amount": "1", "unit": "tablespoon per gallon", "notes": "Feeds bacteria. Do NOT use sulfured molasses — sulfur kills microbes."},
            {"name": "Kelp meal or liquid kelp", "amount": "1", "unit": "teaspoon per gallon", "notes": "Provides growth hormones (cytokinins) and trace minerals for the biology."},
            {"name": "Fish hydrolysate", "amount": "1", "unit": "teaspoon per gallon", "notes": "Optional — provides nitrogen and feeds fungi. Use hydrolysate NOT emulsion (emulsion is heat-processed)."},
        ],
    ...
    },
    {
        ...
        "ingredients": [
            {"name": "Quality compost / worm castings", "amount": "1/4", "unit": "cup per gallon", "notes": "Base biology source."},
            {"name": "Unsulfured blackstrap molasses", "amount": "1", "unit": "tablespoon per gallon", "notes": "Feeds bacteria. Molasses also contains potassium."},
            {"name": "Bat guano (high-P)", "amount": "1", "unit": "tablespoon per gallon", "notes": "Indonesian bat guano (0-7-0 or similar). Feeds phosphorus-cycling fungi."},
            {"name": "Bone meal", "amount": "1", "unit": "teaspoon per gallon", "notes": "Slow-release phosphorus source for the biology to process."},
            {"name": "Kelp meal", "amount": "1", "unit": "teaspoon per gallon", "notes": "Potassium and growth hormones."},
        ],
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "ingredients": [
            {"name": "All-purpose dry amendment (4-4-4)", "amount": "2-3", "unit": "tablespoons per gallon of soil", "notes": "Gaia Green 4-4-4, DTE Bio-Live, or similar balanced organic fertilizer."},
            {"name": "Worm castings", "amount": "1/4", "unit": "inch layer on surface", "notes": "Provides biology to break down amendments and gentle immediate nitrogen."},
            {"name": "Neem meal (6-1-2)", "amount": "1", "unit": "tablespoon per gallon of soil", "notes": "Optional — slow nitrogen + natural pest prevention (fungus gnats, root aphids)."},
            {"name": "Kelp meal (1-0.1-2)", "amount": "1", "unit": "tablespoon per gallon of soil", "notes": "Optional — growth hormones, potassium, 60+ trace minerals."},
        ],
    ...
    },
    {
        ...
        "ingredients": [
            {"name": "Bloom dry amendment (2-8-4 or 4-8-4)", "amount": "2-3", "unit": "tablespoons per gallon of soil", "notes": "Gaia Green Power Bloom, DTE Rose & Flower, or similar high-P organic."},
            {"name": "Worm castings", "amount": "1/4", "unit": "inch layer", "notes": "Biology layer to process amendments."},
            {"name": "Langbeinite (0-0-22)", "amount": "1", "unit": "teaspoon per gallon of soil", "notes": "Optional — sulfate of potash magnesia. Adds K, Mg, and S for terpene/resin production."},
            {"name": "Bone meal (3-15-0)", "amount": "1", "unit": "tablespoon per gallon of soil", "notes": "Optional — extra phosphorus for heavy-feeding strains."},
        ],
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "ingredients": [
            {"name": "Fresh plant growth tips (comfrey, nettle, or alfalfa)", "amount": "equal weight to sugar", "unit": "packed volume", "notes": "Harvest in early morning when hormone levels are highest. Use actively growing tips only."},
            {"name": "Brown sugar (unrefined)", "amount": "equal weight", "unit": "to plant material", "notes": "Creates osmotic extraction. Must be brown/raw sugar — white sugar lacks minerals."},
        ],
    ...
    },
    {
        ...
        "ingredients": [
            {"name": "Ripe banana peels (or papaya, melon)", "amount": "equal weight to sugar", "unit": "by weight", "notes": "Must be fully ripe (brown spots on bananas). Ripeness = maximum potassium and enzymes."},
            {"name": "Brown sugar (unrefined)", "amount": "equal weight", "unit": "to fruit material", "notes": "Same osmotic extraction process as FPJ."},
        ],
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "ingredients": [
            {"name": "Peat moss (or coco coir)", "amount": "1/3", "unit": "of total volume", "notes": "Canadian sphagnum peat or pre-buffered coco coir. This is your water-holding component."},
            {"name": "High-quality compost / worm castings", "amount": "1/3", "unit": "of total volume", "notes": "Mix of compost and worm castings. This provides biology and initial nutrition."},
            {"name": "Aeration (perlite/pumice/lava rock)", "amount": "1/3", "unit": "of total volume", "notes": "Pumice or rice hulls preferred (don't float). Provides oxygen to roots and drainage."},
            {"name": "Neem meal", "amount": "1/2", "unit": "cup per cubic foot", "notes": "Slow-release nitrogen + pest prevention."},
            {"name": "Kelp meal", "amount": "1/2", "unit": "cup per cubic foot", "notes": "Growth hormones, potassium, trace minerals."},
            {"name": "Crustacean meal (crab/shrimp)", "amount": "1/2", "unit": "cup per cubic foot", "notes": "Chitin triggers plant immune response. Also provides calcium and nitrogen."},
            {"name": "Glacial rock dust (or basalt)", "amount": "1", "unit": "cup per cubic foot", "notes": "60+ trace minerals. Provides long-term mineral reserve."},
            {"name": "Gypsum", "amount": "1/2", "unit": "cup per cubic foot", "notes": "Calcium and sulfur without changing pH."},
            {"name": "Oyster shell flour", "amount": "1/2", "unit": "cup per cubic foot", "notes": "Slow-release calcium, pH buffer (prevents soil from becoming too acidic)."},
        ],
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        "ingredients": [
            {"name": "Fresh aloe vera inner gel", "amount": "1/4", "unit": "cup per gallon", "notes": "Fresh fillet from leaf, or 1/8 tsp aloe vera powder (200x concentrate). Must be pure — no added ingredients."},
            {"name": "Dechlorinated water", "amount": "1", "unit": "gallon", "notes": "Chlorine damages plant tissue when foliar applied. Let tap water sit 24h or use RO."},
        ],
    ...
    },
    {
        ...
        "ingredients": [
            {"name": "Whole malted barley grain (2-row preferred)", "amount": "1/2", "unit": "cup per 5 gallons of soil (top dress) or 1/3 cup per gallon water (tea)", "notes": "Must be MALTED (sprouted and dried). Available at homebrew supply stores. Ground fresh is best."},
        ],
