...
| Variable | Required | Default | Description |
|----------|----------|---------|-------------|
| `DOMAIN` | No | `tendrilgrow.com` | Application domain for generated URLs. |
...
| Variable | Required | Default | Description |
|----------|----------|---------|-------------|
| `NEXT_PUBLIC_API_URL` | Yes | `https://api.tendrilgrow.com/v1` | API base URL. Set at build time via Docker `--build-arg`. |
